% This document was written using Kile, as a reference document for using electronics to aid atmospheric research. This document was written over a 6 week period 0.8FT by William Burbidge. Many thanks to the support from Dr Pete Edwards, Killian Murphy and Martyn Ward. The document and all linked images are all available on GitHub %

% Initial setup class and packages, with packages to change formatting, spacing and to allow use of certain symbols %
...
% Packages to allow certain header types and hyperlinks %
\usepackage{todonotes}
\usepackage{hyperref}

% Code used for headers and footers %
\usepackage{fancyhdr}
\pagestyle{fancy}
\cfoot{WACL Electronics Courses}
\fancyfoot[R]{\thepage}

% Package used for images %
\usepackage{graphicx}
\graphicspath{ {./images/} }
...
% Create the command used for theory header
...
% Create the command used for examples header
...
% Create the command used for simulation header
...
% Create the command used for quiz header
...
% Below are the many glossary entries %
...
{ name={Sensor},
  description={A device which measures and responds to physical properties, outputting this as an electrical signal},
  %sort={0}
  }

\newglossaryentry{vltg}
{ name={Voltage},
  description={A Key electronics unit, otherwise known as Electromotive Force or Potential Difference, representing the energy provided to each Coulomb of Charge},
  %sort={0}
  }

\newglossaryentry{crnt}
{ name={Current},
  description={An electrical flow due to directional movement of electrons},
  %sort={0}
  }

\newglossaryentry{rstnc}
{ name={Resistance},
  description={The degree to which a component opposes \gls{crnt} flow},
  %sort={0}
  }
...
{ name={Inductance},
  description={The ability to generate an electromotive force due to changing \gls{crnt} flow},
  %sort={0}
  }

\newglossaryentry{vlt}
{ name={Volt},
  description={The unit for \gls{vltg}},
  %sort={0}
  }

\newglossaryentry{amp}
{ name={Ampere},
  description={The unit for \gls{crnt}, often shortened to Amp},
  %sort={0}
  }
...
{ name={Resistor},
  description={A component which opposes \gls{crnt} flow, causing loss as heat},
  %sort={0}
  }

\newglossaryentry{ptmtr}
{ name={Potentiometer},
  description={A variable \gls{rstr} acting as a \gls{ptldvdr}},
  %sort={0}
  }

\newglossaryentry{srs}
{ name={Series},
  description={It is a circuit configuration where \gls{crnt} passes through each component one after another},
  %sort={0}
  }

\newglossaryentry{prl}
{ name={Parallel},
  description={It is a circuit configuration where a circuit board/node splits into several branches, with \gls{crnt} being divided inversely by a ratio of each branches \gls{rstnc}. It can also stand for a communication bus of multiple con\gls{crnt} data lines},
  %sort={0}
  }

\newglossaryentry{ptldvdr}
{ name={Potential Divider},
  description={A \gls{rstr} configuration used to get an output which is a fraction of a \gls{vltg}. Widely used in sensing},
  %sort={0}
  }

\newglossaryentry{atngcrt}
{ name={AC},
  description={Alternating \gls{crnt} is a \gls{crnt} which continually changes direction as it flows},
  %sort={0}
  }

\newglossaryentry{drtcrt}
{ name={DC},
  description={Direct \gls{crnt} is \gls{crnt} with a constant direction of flow},
  %sort={0}
  }

\newglossaryentry{rms}
{ name={RMS},
  description={This is an acronym for Root Mean Squared. This is the effective value of a waveform, for example the \gls{drtcrt} magnitude equivlane energy wise},
  %sort={0}
  }
...
\newglossaryentry{frd}
{ name={Farad},
  description={The unit for \gls{cptnc}},
  %sort={0}
  }
...
{ name={Henry},
  description={The unit for \gls{idtnc}},
  %sort={0}
  }

\newglossaryentry{diod}
{ name={Diode},
  description={A component which limits how \gls{crnt} can flow},
  %sort={0}
  }
...
\newglossaryentry{dpd}
{ name={Doped},
  description={The process of adding an impurity to a material to alter its characterisitcs. Frequently used to alter the electrical/ conduction properties},
  %sort={0}
  }

\newglossaryentry{led}
{ name={LED},
  description={This stands for Light Emitting \gls{diod}, which are \gls{diod}s \gls{dpd} so that they emit light, typically in the visible spectrum, depening on use case},
  %sort={0}
  }

\newglossaryentry{znr}
{ name={Zener},
  description={A type of \gls{diod} which allows reverse \gls{crnt} flow after a certain threshold \gls{vltg} is met},
  %sort={0}
  }

\newglossaryentry{shtky}
{ name={Schottky},
  description={A type of \gls{diod} which has low \gls{vltg} drop and fast switching},
  %sort={0}
  }

\newglossaryentry{diac}
{ name={DIAC},
  description={A type of \gls{diod} which conducts \gls{crnt} after a certain \gls{vltg} (breakover \gls{vltg}) is momentarily reached},
  %sort={0}
  }

\newglossaryentry{tric}
{ name={TRIAC},
  description={A type of \gls{diod} which will conduct \gls{crnt} in either direction after triggered by a signal at its Gate},
  %sort={0}
  }

\newglossaryentry{trnfmr}
{ name={Transformer},
  description={A device which will increase or decrease the \gls{vltg} of an alternating \gls{crnt} source, having the reverse effect upon \gls{crnt}},
  %sort={0}
  }
...
{ name={Lamination},
  description={It is the process of using stacked sheets of core material rather than a single "block" to limit eddy \gls{crnt}},
  %sort={0}
  }

\newglossaryentry{anlge}
{ name={Analogue},
  description={It is the representation of information like \gls{vltg} as a continuous and variable value},
  %sort={0}
  }

\newglossaryentry{dgtl}
{ name={Digital},
  description={It is where data or signals are expressed either as 0 or 1, enabled by transistors},
  %sort={0}
  }

\newglossaryentry{wvlgt}
{ name={Wavelength},
  description={It is the distance between successive peaks of a wave},
  %sort={0}
  }

\newglossaryentry{prd}
{ name={Period},
  description={An interval of time regarding successive occurances, such as with a wave},
  %sort={0}
  }
...
{ name={Binary},
  description={A mathematical system which uses 2 rather than 10 as a base, often used in computing, due to its compatibility with boolean algebra/ digital electronics},
  %sort={0}
  }
...
{ name={Transistor},
  description={A \gls{smicdtr} meant for electronics control, signal generation or amplification},
  %sort={0}
  }

\newglossaryentry{gte}
{ name={Gate},
  description={It can be thought of as a trigger to allow \gls{crnt} flow in a transistor. Where in boolean algebra, it is an idealized device implementing a Boolean function},
  %sort={0}
  }

\newglossaryentry{bjt}
{ name={BJT},
  description={It is short for Bipolar Junction \gls{trstr}, where the \gls{crnt} flow between the collector and emitter is the \gls{crnt} flow through the base amplified},
  %sort={0}
  }

\newglossaryentry{msft}
{ name={MOSFET},
  description={This stands for Metal-Oxide \gls{smicdtr} Field-Effect \gls{trstr}, and is a \gls{vltg} controlled switch, where a certain \gls{vltg} on its gate will cause \gls{crnt} to flow between its drain and source},
  %sort={0}
  }

\newglossaryentry{elcmgnt}
{ name={Electromagnet},
  description={This is typically a coil of wire which is magnetised only when \gls{crnt} flows through it},
  %sort={0}
  }

\newglossaryentry{dlgtnpr}
{ name={Darlington Pair},
  description={A \gls{trstr} which internally uses a pair of BJT \gls{trstr}s to allow for higher \gls{crnt} amplification than a single BJT},
  %sort={0}
  }

\newglossaryentry{micrctrlr}
{ name={Microcontroller},
  description={An integrated circuit with built-in microprocessor, memory and other IC elements, which can be thought of as a small computer for a specific or embedded task},
  %sort={0}
  }

\newglossaryentry{mems}
{ name={MEMS},
  description={This stands for MicroElectroMechanical Systems, and is a combination of micromechanical components such as springs or levers, along with microelectronic circuitry, such as \gls{cptr} s, widely used for \gls{snsr}s},
  %sort={0}
  }

\newglossaryentry{thrmcpl}
{ name={Thermocouple},
  description={A \gls{snsr} for measuring temperature, based on the \gls{vltg} developed between two junctions, proportional to temperature difference},
  %sort={0}
  }

\newglossaryentry{rtd}
{ name={RTD},
  description={This stands for \gls{rstnc} Temperature Detector and is a \gls{snsr} which has its \gls{rstnc} vary significantly with temperature. Also referred to as a \gls{rstnc} thermometer},
  %sort={0}
  }

\newglossaryentry{thrmstr}
{ name={Thermistor},
  description={A \gls{rstr} whose \gls{rstnc} alters with temperature change, commonly used as a \gls{snsr}},
  %sort={0}
  }
...
{ name={Ultrasonic},
  description={Sound waves above the human audible hearing range, typically above 20000Hz, often used in sensing},
  %sort={0}
  }

\newglossaryentry{lidr}
{ name={LiDAR},
  description={This stands for light detection and ranging, using a laser to measure distance by the time it takes to reflect back to the \gls{snsr}. This method can be known as ToF (Time of Flight)},
  %sort={0}
  }

\newglossaryentry{modl}
{ name={Module},
  description={A Module is a distinct assembly of parts for easier use in a system},
  %sort={0}
  }
...
\newglossaryentry{usb}
{ name={USB},
  description={This stands for Universal Serial Bus, with a collection of linked protocols and connectors},
  %sort={0}
  }
...
\newglossaryentry{mtr}
{ name={Motor},
  description={A device which outputs a motive force, typically converting electrical energy first to magnetic and then to mechanical},
  %sort={0}
  }
...
{ name={Super\gls{cptr} },
  description={A form of \gls{cptr} , with far higher energy density, not far off standard batteries, ideal for high power scenarios, due to their low \gls{rstnc}},
  %sort={0}
  }

\newglossaryentry{impdnc}
{ name={Impedance},
  description={This is the effective \gls{rstnc} of an \gls{atngcrt} circuit, being a combination of both \gls{rstnc} and reactance},
  %sort={0}
  }

\newglossaryentry{ractnc}
{ name={Reactance},
  description={This is due to a combination of \gls{idtnc} and \gls{cptnc}, and makes up the non-reactive part of impedance, therefore \gls{atngcrt} specific},
  %sort={0}
  }

\newglossaryentry{rectfctn}
{ name={Rectification},
  description={This is the process of converting between \gls{atngcrt} and \gls{drtcrt} },
  %sort={0}
  }

\newglossaryentry{rectfir}
{ name={Rectifier},
  description={A component which allows \gls{atngcrt} to \gls{drtcrt} conversion},
  %sort={0}
  }

\newglossaryentry{srl}
{ name={Serial},
  description={Refers to data communication through a single data line},
  %sort={0}
  }

\newglossaryentry{prt}
{ name={Port},
  description={This is a point where communication can be done from, usually with a select number of protocols},
  %sort={0}
  }

\newglossaryentry{urt}
{ name={UART},
  description={A component for converting between \gls{prl} and serial data, for better communication. UART stands for Universal Asynchronous Reciever-Transmitter},
  %sort={0}
  }
...
{ name={ModBus},
  description={The most common protocol for communication between industrial devices},
  %sort={0}
  }

\newglossaryentry{asycns}
{ name={Asynchronous},
  description={A type of communication where data transfer is not based from a set clock rate},
  %sort={0}
  }
...
{ name={Datasheet},
  description={A document which provides the specifications for a product or component, often including how it can be used within a circuit},
  %sort={0}
  }

\newglossaryentry{esd}
{ name={ESD},
  description={This stands for Electrostatic Discharge, and is the sudden flow of \gls{crnt} between two electrically charged objects, typically through contact. Steps should be taken to avoid this, which can cause damage},
  %sort={0}
  }
...
\newglossaryentry{ram}
{ name={RAM},
  description={This stands for Random Access Memory, which is fast to access, short term memory, not saved on power off},
  %sort={0}
  }
...
{ name={Flash},
  description={This is a memory type which retains its data without power, which can be read from and written to},
  %sort={0}
  }

\newglossaryentry{opmp}
{ name={OpAmp},
  description={This stands for Operational Amplifier, and is an IC for \gls{vltg} amplification, which can be used in a range of configurations, depending on intended output},
  %sort={0}
  }

\newglossaryentry{multmtr}
{ name={Multimeter},
  description={A common piece of test equipment typically for measuring \gls{crnt}, \gls{vltg} and \gls{rstnc}, sometimes with extra functions such as \gls{cptnc} or transistor \gls{crnt} gain measurement},
  %sort={0}
  }

\newglossaryentry{osclscp}
{ name={Oscilloscope},
  description={A piece of equipment for measuring and visualising \gls{vltg} or \gls{crnt} against time, such as for viewing oscillations},
  %sort={0}
  }
...
\newglossaryentry{flx}
{ name={Flux},
  description={A substance added to solder to improve its wetting ability, by removing oxides},
  %sort={0}
  }
...
{ name={Libraries},
  description={A collection of scripts/ programs for a specific use, such as interfacing with a certain \gls{snsr}},
  %sort={0}
  }
...
{ name={Heatsink},
  description={An object used to absorb and dissipate unwanted heat, typically made out of aluminium or copper. Can be passively cooled through natural air \gls{crnt}s, or actively cooled through a liquid cooling loop or fan},
  %sort={0}
  }
...
{ name={Parasitics},
  description={These undesirable characteristics affecting components or the circuit, typically being \gls{idtnc} or \gls{cptnc}. These tend to have more of an effect with high speed electronics},
  %sort={0}
  }
...
There may be the case where a constant heat power output is required. A \gls{rstr} is purely resistive, so all the electrical power it uses should be dissipated as heat. Lets say there is a supply of 240V (to simply represent mains \gls{vltg}), and a 2000W supply of heat is required (of a similar magnitude to an oven). Therefore, using $V=IR$ and $P=IV$. Starting with $P=IV$, we can find a \gls{crnt} of the below:
\[I=\frac{P}{V}, I=\frac{2000}{240}, I=\frac{25}{3}A\]
We can now use this in:
\[V=IR, R=\frac{V}{I}, R=\frac{240}{\frac{25}{3}}, R=28.8\ohm\]
In reality, most heater systems will have a \gls{ctrlloop}, with a focus to achieve and then sustain a given temperature, so there would be an element of sensing and turning the heater on and off, which we will get to later in the document.
...
\caption{\gls{prl} example circuit 1}
\end{figure}

Therefore, an example with the following circuit with 2 \gls{rstr}s of 3$\ohm$ and 7$\ohm$, in \gls{prl} with a single \gls{rstr} of 15$\ohm$. You first add the \gls{srs} \gls{rstr}s, therefore an equivalent \gls{rstr} $R_1$ is 10$\ohm$ and $R_2$ is 15$\ohm$. Putting it into the equation gives us the below:
\[\frac{1}{R_{total}} = \frac{1}{10} + \frac{1}{15}\]
\[\frac{1}{R_{total}} = \frac{1}{6}\]
\[R_{total} = 6\ohm\]

If we were to think again of the mail network analogy, a \gls{srs} circuit has the mailpeople take multiple stops on their journey, handing a certain amount of letters to each, depending on their need/\gls{rstnc}. With a \gls{prl} circuit, some mailpeople will focus on different paths, so will still have the same total parcels for their path (the \gls{vltg} stays the same for each path). The \gls{crnt} decreases, since the mailpeople split to go down different routes.
...
\caption{\gls{atngcrt} Wave example graph}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{dcwave}
\caption{\gls{drtcrt} Wave example graph}
\end{figure}
...
\caption{\gls{indctr} representations}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{inductorPackages}
\caption{Common \gls{indctr} Packages}
\end{figure}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.4\textwidth]{mechswitches}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewcaseled1}
\caption{LabVIEW Case Based \gls{led} Final Block Diagram}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewcaseled2}
\caption{LabVIEW Case Based \gls{led} Final Front Panel}
\end{figure}

\textbf{LabVIEW Datalog Example}

As a final example, it would be useful to look at a quick example using Datalogging. Datalogging, which we haven't touched upon yet could be really helpful in the automation process, by being able to record data which is used within the program, in a form that could then be used with data processing programs or languages. We will also showcase the use of an inbuilt sensor block, for the TMP35 temperature sensor.

Firstly, we will get all the blocks we need, we will simply do things within a While Structure.

Again, we will simply do a system which regulates temperature, by turning on and off a digital pin, which triggers a heater to turn on (We will also use an LED on the front panel to show this).

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog1}
\caption{LABVIEW Datalog Example Initial Block View Setup}
\end{figure}

We can simply use a "Vertical Fill Slide", found in "Numeric" to decide a temperature, and then use a "Less?" comparison to check this compared to the measured temperature.

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog2}
\caption{LABVIEW Datalog Example Temperature Comparison Block View}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog3}
\caption{LABVIEW Datalog Example Temperature Comparison Front Panel}
\end{figure}

We can now add in the "Write Meas File" block from "File I/O". This will pop up with some configuration, just to choose the filename and type, which as a quick example we will do in the Excel format.

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog4}
\caption{LABVIEW Datalog Write Meas Block Find}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog5}
\caption{LABVIEW Datalog Write Meas File Configuration}
\end{figure}

Just to keep it very simple, we will wire the temperature output of the sensor to the "Signals".

\begin{figure}[H]
\centering
\includegraphics[width=0.6\textwidth]{screenshots/labviewdatalog6}
\caption{LABVIEW Datalog Write Meas Example Wireup}
\end{figure}

This is another basic example done! In reality, you would want to measure multiple signals to make useful comparisons, which can be done with the Write Meas File Configuration.

\subsection{LabVIEW Cheatsheet}
